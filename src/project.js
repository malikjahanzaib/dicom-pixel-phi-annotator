...
export function validateBackup(value) {
  if(!['occlude-project','pixel-zone-project'].includes(value?.format)||value.version!==1||!Array.isArray(value.images))throw new Error('Not a supported Occlude annotation backup.');
  const ids=new Set();
